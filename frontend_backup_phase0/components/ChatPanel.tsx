...
export function ChatPanel({
  ...
  return (
    <div className="flex flex-col h-full bg-bg-1/90 backdrop-blur-2xl border border-border-strong rounded-2xl overflow-hidden shadow-[0_32px_64px_rgba(0,0,0,0.6)]">
                ...
                {m.role === "assistant" ? (
                  <>
                    ...
                    {m.metadata?.viz_specs && (
                      <div className="mt-4 w-full h-[320px] rounded-xl overflow-hidden border border-white/10 bg-black/40">
      ...
      {/* ── Input Box ────────────────────────────────────────────────────── */}
      <div className="shrink-0 px-4 py-3 border-t border-white/5 bg-bg-2/40">
